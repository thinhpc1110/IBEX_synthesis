...
set osu_t12lib ../../sky130_osu_sc_t12/12T_hs/lib
set_db init_lib_search_path [list $fd_sclib $osu_t18lib $osu_t12lib]

set search_path [list "./" ]
lappend search_path $fd_sclib
lappend search_path $osu_t18lib 
lappend search_path $osu_t12lib 
...
# Report Timing
set filename [format "%s%s%s" "reports_ibex_2/" $my_toplevel "_timing.rep"]
redirect $filename { report_timing -nets -nworst 1}
# Report Area
set filename [format "%s%s%s" "reports_ibex_2/" $my_toplevel "_area.rep"]
redirect $filename { report_area}
# Report QoR
set filename [format "%s%s%s" "reports_ibex_2/" $my_toplevel "_qor.rep"]
redirect $filename { report_qor}
# Report Clocks
set filename [format "%s%s%s" "reports_ibex_2/" $my_toplevel "_clocks.rep"]
redirect $filename { report_clocks}
# Report Timing Summary
set filename [format "%s%s%s" "reports_ibex_2/" $my_toplevel "_timing_summary.rep"]
redirect $filename { report_timing_summary}
# Report Power
set filename [format "%s%s%s" "reports_ibex_2/" $my_toplevel "_power.rep"]
